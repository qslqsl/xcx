...
Page({
  ...
  ImgCode: function (e) {
    ...
    console.log(that.data.userImgCode)
  },
  Code: function (e) {
    let that = this;
    that.setData({
  ...
  Register: function () {
    ...
    if (userphone == '') {
      ...
      setTimeout(function(){
        wx.navigateTo({
          url: '../RegisterSetNickName/RegisterSetNickName',
        })
      },1000)
    }
  },
  ...
  aaaa: function (e) {
    ...
    console.log(idtwo)
    let that = this
    let tel = that.data.groups[idtwo].users[that.data.sd].tel
    console.log(tel)
    that.setData({
  ...
  //   let id = e.currentTarget.id
  //   let tel = this.data.groups[this.data.dd].users[id].tel
  //   console.log(tel)
  //   this.setData({
  //     CountryNumberValue: tel
  //   })
  ...
  // },
  // bbb:function(e){
  //   let idthree = e.currentTarget.id
  //   console.log(idthree)
  //   this.setData({
  //     dd: idthree
  //   })
